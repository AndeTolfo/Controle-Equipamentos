...
begin
  ...
  try
    ...
    begin
      ...
      // Busca o código do funcionário antigo antes do update no equipamento interno
      DM.ReadEquipamentos.Close;
      ...
      // Verifica se foi vinculado um novo funcionário ao equipamento e adiciona o registro no HIST_MAQUINAS
